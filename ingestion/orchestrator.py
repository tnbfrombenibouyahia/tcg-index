...
# NOTE HISTORIQUE (2026-08-22) : une sync batch par rotation pour les
# singles (EBAY_SINGLES_SYNC_JOBS/EBAY_SINGLES_NUM_SLICES/
# run_ebay_singles_listings_sync, ~5 semaines/cycle pour couvrir les 68 202
# items) a existé ici quelques heures avant d'être retirée -- retour
# utilisateur explicite : un chiffre vieux d'un mois n'aide personne à
# décider d'un achat. Remplacée par un scrape À LA DEMANDE au moment de la
# consultation (cf. pricing/active_listings_source.py, appelé depuis
# shared/verdict.py) -- aucun cron dédié aux singles n'existe plus, le
# scellé continue seul sur son batch hebdomadaire (run_ebay_listings_sync
# ci-dessus, inchangé).
