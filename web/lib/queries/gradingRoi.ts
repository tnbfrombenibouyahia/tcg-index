...
async function fetchCandidates({
  ...
  const rows = await sql<RawRow[]>`
    ...
    SELECT
      ...
      l.n8::int               AS "cardN8",
      l.n9::int               AS "cardN9",
      l.n95::int              AS "cardN95",
      l.n10::int              AS "cardN10",
      l.sr_n7::int            AS "srN7",
      l.sr_n8::int            AS "srN8",
      l.sr_n9::int            AS "srN9",
      l.sr_n95::int           AS "srN95",
      l.sr_n10::int           AS "srN10",
      l.set_n7::int           AS "setN7",
      l.set_n8::int           AS "setN8",
      l.set_n9::int           AS "setN9",
      l.set_n95::int          AS "setN95",
      l.set_n10::int          AS "setN10",
      l.tcg_n7::int            AS "tcgN7",
      l.tcg_n8::int            AS "tcgN8",
      l.tcg_n9::int            AS "tcgN9",
      l.tcg_n95::int           AS "tcgN95",
      l.tcg_n10::int           AS "tcgN10"
    FROM prices p
