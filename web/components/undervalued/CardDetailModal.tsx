        ...
        <div className="flex items-start gap-4 border-b border-border p-5">
          {row.imageUrl ? (
            ...
            <img
              src={row.imageUrl}
              alt={row.name}
              className="h-32 w-24 flex-shrink-0 rounded-lg object-contain bg-white shadow-sm"
              style={{ aspectRatio: "3/4" }}
            />
          ) : (
            <div className="h-32 w-24 flex-shrink-0 rounded-lg bg-muted" />
          )}
